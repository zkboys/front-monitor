...
import { FrontMonitor, Window } from '@front-monitor/types';
...
// 获取全部变量__frontMonitor__的引用地址
export function getGlobalSupport() {
  _global.__frontMonitor__ = _global.__frontMonitor__ || ({} as FrontMonitor);
  return _global.__frontMonitor__;
}
