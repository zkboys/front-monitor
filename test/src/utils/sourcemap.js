...
export const findCodeBySourceMap = async ({ fileName, line, column }, callback) => {
  ...
  if (process.env.NODE_ENV == 'development') {
    ...
    if (result.source && result.source.includes('node_modules')) {
      ...
      // 比如echart报错 webpack://front-monitor/node_modules/.pnpm/echarts@5.4.1/node_modules/echarts/lib/util/model.js
      return Message({
        type: 'error',
        duration: 5000,
    ...
    // 测试中发现会有路径中带/./的情况，如 webpack://front-monitor/./src/main.js
    if (index === -1) {
